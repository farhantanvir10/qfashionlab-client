                ...
                <div className=" lg:w-1/2 m-3 sm:m-6">
                    ...
                    <div className="flex">
                        ...
                        >
                            ...
                            <option value="SWEET HONEYCOMB PREMIUM">SWEET HONEYCOMB PREMIUM</option>
                            <option value="JACQUARD DRY-FIT FABRIC (AIR MESH JACQUARD)">
                                JACQUARD DRY-FIT FABRIC (AIR MESH JACQUARD)
                            </option>
                        </select>
                    </div>
